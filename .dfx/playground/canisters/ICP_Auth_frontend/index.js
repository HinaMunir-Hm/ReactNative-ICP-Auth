...
import { idlFactory } from './ICP_Auth_frontend.did.js';
export { idlFactory } from './ICP_Auth_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ICP_AUTH_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ICP_Auth_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ICP_Auth_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ICP_Auth_frontend.did.js")._SERVICE>}
 */
export const ICP_Auth_frontend = createActor(canisterId);
